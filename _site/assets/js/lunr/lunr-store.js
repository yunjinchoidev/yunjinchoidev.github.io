var store = [{
        ...
        "excerpt":"해결 전략 선생님들이 학생을 발견할 수 없는 장애물을 설치할 수 있는지 없는지 여부를 확인하는 문제입니다. 선생님들의 감시 경로를 DFS 로 구현합니다. N 의 주어진 범위가 적으니 조합을 모두 구하고 각각에 대하여 DFS 를 수행하면 됩니다. 생각정리 시간복잡도 -&gt; 완전탐색으로 풀어도 되겠다. 3개의 장애물을 만든다. -&gt; combination 을 쓰자. 36*35*34 /...","categories": ["ps"],
        "tags": [],
